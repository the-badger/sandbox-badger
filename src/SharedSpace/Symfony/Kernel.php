...
class Kernel extends BaseKernel
{
    ...
    protected function configureContainer(ContainerBuilder $container, LoaderInterface $loader): void
    {
        ...
        foreach ($this->registeredBoundedContext() as $boundedContextClassName) {
            $boundedContextExtension = new $boundedContextClassName();

            $container->registerExtension(new SymfonyExtension($boundedContextExtension));
        }
    ...
    {
        return [
            GamificationContainerExtension::class,
        ];
    }
}
